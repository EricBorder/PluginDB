...
function insertValoresTablas() {
    ...
    $sql15 = "INSERT INTO $table_name1 (id, text) VALUES (5, 'pirola')";

    $sql21 = "INSERT INTO $table_name2 (id, text) VALUES (1, 'excremento')";
    $sql22 = "INSERT INTO $table_name2 (id, text) VALUES (2, 'trasero')";
    $sql23 = "INSERT INTO $table_name2 (id, text) VALUES (3, 'flatulencia')";
    $sql24 = "INSERT INTO $table_name2 (id, text) VALUES (4, 'orina')";
    $sql25 = "INSERT INTO $table_name2 (id, text) VALUES (5, 'pene')";
